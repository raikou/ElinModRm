...
namespace RmModManager.Patches
{
    ...
    public class OnProgressCompletePatch
	{
		...
		private BaitAndStaminaAllDatas _datasHistory = new BaitAndStaminaAllDatas(); //変化履歴データ
	    ...
	    public class BaitAndStamina
	    {
		    ...
		    public BaitAndStamina(ref AI_Fish.ProgressFish instance, ref Chara owner) {
			    IsPC = instance.owner.IsPC;
